export default {
  ...
  "aboutInfo": "This is a creative AI platform that integrates various AI services including drawing, music, video and more.",
  ...
  "mjchat": {
    ...
    "dalleNote1": "DALL-E is an image generation model provided by OpenAI",
    "dalleNote2": "OpenAI images have an expiration date, so make backups", 
    "dalleNote3": "Note: The price of 1790px images is double",
    "dalleNote4": "Note: dall-e-2 and gpt-image-1 support multiple image references",
    "version": "Version",
    "size": "Size",
